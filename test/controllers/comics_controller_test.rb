...
class ComicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post comics_url, params: { comic: { description: @comic.description, release_date: @comic.release_date, title: @comic.title } }
    end
  ...
  test "should update comic" do
    patch comic_url(@comic), params: { comic: { description: @comic.description, release_date: @comic.release_date, title: @comic.title } }
